...
func (u *UseCase) VerifyAccess(ctx context.Context, projectID int, userID int, permission string) error {
	res, err := u.projectRepo.HasPermission(ctx, projectID, userID, permission)
	if err != nil {
		return u.errHandler.InternalTrouble(
